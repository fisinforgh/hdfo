...
MyMainFrame::MyMainFrame(const TGWindow *p,UInt_t w,UInt_t h) {
  ...
  spathHIDEN_FILE.Append("/.pathDIR_HDFo.txt");
  //cout << "spathHIDEN_FILE: " << spathHIDEN_FILE << endl;
  ...
  TGHorizontalFrame *fHorizontalFrameMain = new TGHorizontalFrame(fMainFrameHDFOSC,1285,731,kHorizontalFrame | kRaisedFrame);
  fHorizontalFrameMain->SetName("fHorizontalFrameMain");

  

  //======== VERTICAL FRAME 1

  TGVerticalFrame *fVerticalFrameV1 = new TGVerticalFrame(fHorizontalFrameMain,312,725,kVerticalFrame);
  fVerticalFrameV1->SetName("fVerticalFrameV1");
  //fVerticalFrameV1->SetLayoutBroken(kTRUE);

  ULong_t ucolor;        // will reflect user color changes
  gClient->GetColorByName("#cccc99",ucolor);

  //****** "Timing and Forced oscillations" group frame
  TGGroupFrame *fGroupFrameFO = new TGGroupFrame(fVerticalFrameV1,"Timing and Forced oscillations",kVerticalFrame,TGGroupFrame::GetDefaultGC()(),TGGroupFrame::GetDefaultFontStruct(),ucolor);
  ...
  //TGLabel *fLabelDT = new TGLabel(fGroupFrameFO,"Time step dt [ s ]");
  ...
  fLabelDT->MoveResize(10,24,87,14);
  ...
  //TGLabel *fLabelRT = new TGLabel(fGroupFrameFO,"Run time t_f [ s ]");
  ...
  fLabelRT->MoveResize(169,24,86,14);
  
  fNumberEntryDT = new TGNumberEntry(fGroupFrameFO, (Double_t) 0,6,-1,(TGNumberFormat::EStyle) 5);
  fGroupFrameFO->AddFrame(fNumberEntryDT, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
  fNumberEntryDT->MoveResize(10,54,58,20);
  ...
  fNumberEntryRT = new TGNumberEntry(fGroupFrameFO, (Double_t) 0,6,-1,(TGNumberFormat::EStyle) 5);
  fGroupFrameFO->AddFrame(fNumberEntryRT, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
  fNumberEntryRT->MoveResize(169,54,58,20);
  ...
  //TGLabel *fLabelFO = new TGLabel(fGroupFrameFO,"(FoSin(wt)) Fo [ N ]");
  fLabelFO->SetTextJustify(36);
  fLabelFO->SetMargins(0,0,0,0);
  fLabelFO->SetWrapLength(-1);
  fGroupFrameFO->AddFrame(fLabelFO, new TGLayoutHints(kLHintsRight,2,2,2,2));
  fLabelFO->MoveResize(10,84,101,14);

  fNumberEntryFO = new TGNumberEntry(fGroupFrameFO, (Double_t) 0,6,-1,(TGNumberFormat::EStyle) 5);
  fGroupFrameFO->AddFrame(fNumberEntryFO, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
  fNumberEntryFO->MoveResize(169,84,58,20);
  ...
  //TGLabel *fLabelWF = new TGLabel(fGroupFrameFO,"Forced frequency [ rad/s ]");
  ...
  fLabelWF->MoveResize(10,114,137,14);

  fNumberEntryWF = new TGNumberEntry(fGroupFrameFO, (Double_t) 0,6,-1,(TGNumberFormat::EStyle) 5);
  fGroupFrameFO->AddFrame(fNumberEntryWF, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
  fNumberEntryWF->MoveResize(169,114,58,20);
  ...
  fCheckButtonFORCED->MoveResize(10,144,149,15);
  
  fGroupFrameFO->SetLayoutManager(new TGVerticalLayout(fGroupFrameFO));
  fGroupFrameFO->Resize(283,174);
  fVerticalFrameV1->AddFrame(fGroupFrameFO, new TGLayoutHints(kLHintsCenterX,2,2,2,2));
  fGroupFrameFO->MoveResize(14,2,283,174);
  //******
  ...
  TGGroupFrame *fGroupFrameHD = new TGGroupFrame(fVerticalFrameV1,"Harmonic Damped Oscillations",kVerticalFrame,uGC->GetGC(),ufont->GetFontStruct(),ucolor);
  ...
  //  TGLabel *fLabelK = new TGLabel(fGroupFrameHD,"Spring constant K [ N/m ]");
  ...
  fLabelK->MoveResize(10,24,133,14);

  fNumberEntryK = new TGNumberEntry(fGroupFrameHD, (Double_t) 0,6,-1,(TGNumberFormat::EStyle) 5);
  fGroupFrameHD->AddFrame(fNumberEntryK, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
  fNumberEntryK->MoveResize(194,24,58,20);
  ...
  //TGLabel *fLabelB = new TGLabel(fGroupFrameHD,"Damping constant b (-bv) [ kg/s ]");
  ...
  fLabelM->MoveResize(10,84,70,14);
   
  fNumberEntryM = new TGNumberEntry(fGroupFrameHD, (Double_t) 0,6,-1,(TGNumberFormat::EStyle) 5);
  fGroupFrameHD->AddFrame(fNumberEntryM, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
  fNumberEntryM->MoveResize(194,84,58,20);
  ...
  //  TGLabel *fLabelA0 = new TGLabel(fGroupFrameHD,"Init Amplitude A0 [ m ]");
  ...
  fLabelA0->MoveResize(10,114,117,14);
  ...
  //  TGLabel *fLabelPH = new TGLabel(fGroupFrameHD,"Fase phi (deg)");
  ...
  fLabelPH->MoveResize(194,114,79,14);

  fNumberEntryA0 = new TGNumberEntry(fGroupFrameHD, (Double_t) 0,6,-1,(TGNumberFormat::EStyle) 5);
  fGroupFrameHD->AddFrame(fNumberEntryA0, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
  fNumberEntryA0->MoveResize(10,144,58,20);

  fNumberEntryPH = new TGNumberEntry(fGroupFrameHD, (Double_t) 0,6,-1,(TGNumberFormat::EStyle) 5);
  fGroupFrameHD->AddFrame(fNumberEntryPH, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
  fNumberEntryPH->MoveResize(194,144,58,20);
  ...
  fGroupFrameHD->Resize(296,192);
  fVerticalFrameV1->AddFrame(fGroupFrameHD, new TGLayoutHints(kLHintsCenterX | kLHintsTop));
  fGroupFrameHD->MoveResize(8,178,296,192);
  //********
  ...
  TGGroupFrame *fGroupFrameOD = new TGGroupFrame(fVerticalFrameV1,"Overdamped Oscillations",kVerticalFrame,TGGroupFrame::GetDefaultGC()(),TGGroupFrame::GetDefaultFontStruct(),ucolor);
  ...
  //TGLabel *fLabelX0 = new TGLabel(fGroupFrameOD,"Init Pos x(0) [ m ]");
  ...
  fLabelX0->MoveResize(10,24,89,14);
  ...
  // TGLabel *fLabelV0 = new TGLabel(fGroupFrameOD,"Init Speed v(0) [ m/s ]");
  ...
  fLabelV0->MoveResize(133,24,113,14);

  fNumberEntryX0 = new TGNumberEntry(fGroupFrameOD, (Double_t) 0,6,-1,(TGNumberFormat::EStyle) 5);
  fGroupFrameOD->AddFrame(fNumberEntryX0, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
  fNumberEntryX0->MoveResize(10,54,58,20);

  fNumberEntryV0 = new TGNumberEntry(fGroupFrameOD, (Double_t) 0,6,-1,(TGNumberFormat::EStyle) 5);
  fGroupFrameOD->AddFrame(fNumberEntryV0, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
  fNumberEntryV0->MoveResize(133,54,58,20);
  ...
  fGroupFrameOD->Resize(304,96);
  fVerticalFrameV1->AddFrame(fGroupFrameOD, new TGLayoutHints(kLHintsNormal));

  //*****

  //******RUNNING LABELS
  fGroupFrameOD->MoveResize(0,370,304,96);

  fLabelW = new TGLabel(fVerticalFrameV1,"W =sqrt[Wo^2 - (b/2m)^2]: [ rad/s ]");
  fLabelW->SetTextJustify(36);
  fLabelW->SetMargins(0,0,0,0);
  fLabelW->SetWrapLength(-1);
  fVerticalFrameV1->AddFrame(fLabelW, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,5,5));
  fLabelW->MoveResize(2,471,62,14);
  
  fLabelW0 = new TGLabel(fVerticalFrameV1,"Wo: gamma (b/2m): [ rad/s]");
  fLabelW0->SetTextJustify(36);
  fLabelW0->SetMargins(0,0,0,0);
  fLabelW0->SetWrapLength(-1);
  fVerticalFrameV1->AddFrame(fLabelW0, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,5,5));
  fLabelW0->MoveResize(2,495,62,14);
  
  fLabelSTEP = new TGLabel(fVerticalFrameV1,"Running 0 Iterations out of 0");
  fLabelSTEP->SetTextJustify(36);
  fLabelSTEP->SetMargins(0,0,0,0);
  fLabelSTEP->SetWrapLength(-1);
  fVerticalFrameV1->AddFrame(fLabelSTEP, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,5,5));
  fLabelSTEP->MoveResize(2,519,62,14);
  
  //*******

  
  fHorizontalFrameMain->AddFrame(fVerticalFrameV1, new TGLayoutHints(kLHintsLeft | kLHintsTop | kLHintsExpandY,2,2,2,2));

  //=======END VERTICAL FRAME 1

  
  //======= VERTICAL FRAME 2
  TGVerticalFrame *fVerticalFrameV2 = new TGVerticalFrame(fHorizontalFrameMain,963,725,kVerticalFrame | kRaisedFrame);
  fVerticalFrameV2->SetName("fVerticalFrameV2");
  //fVerticalFrameV2->SetLayoutBroken(kTRUE);

  //******* embedded canvas
  fECanvas = new TRootEmbeddedCanvas(0,fVerticalFrameV2,880,552,kSunkenFrame);
  fECanvas->SetName("fECanvas");
  Int_t wfECanvas = fECanvas->GetCanvasWindowId();
  TCanvas *c126 = new TCanvas("c126", 10, 10, wfECanvas);
  fECanvas->AdoptCanvas(c126);
  fVerticalFrameV2->AddFrame(fECanvas, new TGLayoutHints(kLHintsLeft | kLHintsTop | kLHintsExpandX | kLHintsExpandY,2,2,2,2));
  fECanvas->MoveResize(48,32,880,552);
  //*******

  
  //******* horizontal frame
  TGHorizontalFrame *fHorizontalFrameH = new TGHorizontalFrame(fVerticalFrameV2,957,106,kHorizontalFrame);
  fHorizontalFrameH->SetName("fHorizontalFrameH");
  //fHorizontalFrameH->SetLayoutBroken(kTRUE);

  TGIcon *fIconHDFo = new TGIcon(fHorizontalFrameH, pathDIR_ICONS + "logoHDFo.png");
  fIconHDFo->SetName("logoHDFo");
  fHorizontalFrameH->AddFrame(fIconHDFo, new TGLayoutHints(kLHintsCenterX | kLHintsCenterY,2,2,2,2));
  fIconHDFo->MoveResize(2,36,80,60);

  TGVertical3DLine *fVertical3DLineA = new TGVertical3DLine(fHorizontalFrameH,8,102);
  fVertical3DLineA->SetName("fVertical3DLineA");
  fHorizontalFrameH->AddFrame(fVertical3DLineA, new TGLayoutHints(kLHintsLeft | kLHintsCenterX | kLHintsTop,2,2,2,2));
  fVertical3DLineA->MoveResize(95,2,8,102);
  ...
  fTextButtonDRAW->Resize(97,20);
  fHorizontalFrameH->AddFrame(fTextButtonDRAW, new TGLayoutHints(kLHintsCenterX | kLHintsCenterY,2,2,2,2));
  fTextButtonDRAW->MoveResize(172,43,97,20);
  ...
  fTextButtonSTOP = new TGTextButton(fHorizontalFrameH,"&STOP",-1,uGC->GetGC(),ufont->GetFontStruct(),kRaisedFrame);
  fTextButtonSTOP->SetTextJustify(36);
  fTextButtonSTOP->SetMargins(0,0,0,0);
  fTextButtonSTOP->SetWrapLength(-1);
  fTextButtonSTOP->Resize(97,20);
  fHorizontalFrameH->AddFrame(fTextButtonSTOP, new TGLayoutHints(kLHintsLeft | kLHintsCenterX | kLHintsTop | kLHintsCenterY,2,2,2,2));
  fTextButtonSTOP->MoveResize(293,43,97,20);
  ...
  fTextButtonCONTINUE->Resize(97,20);
  fHorizontalFrameH->AddFrame(fTextButtonCONTINUE, new TGLayoutHints(kLHintsCenterX | kLHintsCenterY,2,2,2,2));
  fTextButtonCONTINUE->MoveResize(414,43,97,20);
  ...
  fTextButtonCLEAR->Resize(97,20);
  fHorizontalFrameH->AddFrame(fTextButtonCLEAR, new TGLayoutHints(kLHintsCenterX | kLHintsCenterY,2,2,2,2));
  fTextButtonCLEAR->MoveResize(535,43,97,20);
  ...
  fTextButtonEXIT->Resize(97,20);
  fHorizontalFrameH->AddFrame(fTextButtonEXIT, new TGLayoutHints(kLHintsCenterX | kLHintsCenterY,2,2,2,2));
  fTextButtonEXIT->MoveResize(656,43,97,20);
  TGVertical3DLine *fVertical3DLineB = new TGVertical3DLine(fHorizontalFrameH,8,102);
  fVertical3DLineB->SetName("fVertical3DLineB");
  fHorizontalFrameH->AddFrame(fVertical3DLineB, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
  fVertical3DLineB->MoveResize(767,2,8,102);
  ...
  fTextButtonHELP = new TGTextButton(fHorizontalFrameH,"&HELP",-1,uGC->GetGC(),ufont->GetFontStruct(),kRaisedFrame);
  fTextButtonHELP->SetTextJustify(36);
  fTextButtonHELP->SetMargins(0,0,0,0);
  fTextButtonHELP->SetWrapLength(-1);
  fTextButtonHELP->Resize(97,20);
  fHorizontalFrameH->AddFrame(fTextButtonHELP, new TGLayoutHints(kLHintsCenterX | kLHintsCenterY,2,2,2,2));
  fTextButtonHELP->MoveResize(789,43,97,20);
  fTextButtonHELP->Connect("Clicked()","MyMainFrame",this,"DoHelp()");


  TGVertical3DLine *fVertical3DLineC = new TGVertical3DLine(fHorizontalFrameH,8,102);
  fVertical3DLineC->SetName("fVertical3DLineC");
  fHorizontalFrameH->AddFrame(fVertical3DLineC, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
  fVertical3DLineC->MoveResize(900,2,8,102);

  TGIcon *UDicon = new TGIcon(fHorizontalFrameH, pathDIR_ICONS + "logoUD.png");
  UDicon->SetName("logoUD");
  fHorizontalFrameH->AddFrame(UDicon, new TGLayoutHints(kLHintsCenterX | kLHintsCenterY,2,2,2,2));
  UDicon->MoveResize(921,36,150,60);
  
  fVerticalFrameV2->AddFrame(fHorizontalFrameH, new TGLayoutHints(kLHintsCenterX | kLHintsExpandX,2,2,2,2));
  fHorizontalFrameH->MoveResize(3,616,957,106);
  //*****

  
  fHorizontalFrameMain->AddFrame(fVerticalFrameV2, new TGLayoutHints(kLHintsLeft | kLHintsTop | kLHintsExpandX | kLHintsExpandY,2,2,2,2));
  //======= END VERTICAL FRAME 2

  fMainFrameHDFOSC->AddFrame(fHorizontalFrameMain, new TGLayoutHints(kLHintsLeft | kLHintsTop | kLHintsExpandX | kLHintsExpandY,2,2,2,2));
  // END MAIN horizontal frame
