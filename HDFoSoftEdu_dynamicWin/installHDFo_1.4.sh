...
echo "wget https://raw.githubusercontent.com/fisinforgh/hdfo/main/HDFoSoftEdu_dynamicWin/$tarFILE -P $dirPATH"
echo "Wait..."
(wget -O $dirPATH/$tarFILE https://raw.githubusercontent.com/fisinforgh/hdfo/main/HDFoSoftEdu_dynamicWin/$tarFILE) | zenity --progress --width=800 --height=400 --auto-close \
										     --title="HDFoEdu_2.0 Install" \
...
if [ -f "$FILE" ]; then
    rm $FILE
    ($pathROOTCLING -f SEHDFoDict_v2.cxx -c SEHDFo_v2.h SEHDFoLinkDef_v2.h
     g++ -o SEHDFo_v2 SEHDFo_v2.cxx  SEHDFoDict_v2.cxx `$pathROOTCONFIG --cflags --glibs`) | zenity --progress --width=800 --height=400 --auto-close \
												    --title="HDFoEdu_2.0 Install" \
												    --text="Compiling HDFoEdu_2.0 software" \
												    --percentage=10
else
    ($pathROOTCLING -f SEHDFoDict_v2.cxx -c SEHDFo_v2.h SEHDFoLinkDef_v2.h
     g++ -o SEHDFo_v2 SEHDFo_v2.cxx  SEHDFoDict_v2.cxx `$pathROOTCONFIG --cflags --glibs`) | zenity --progress --width=800 --height=400 --auto-close \
